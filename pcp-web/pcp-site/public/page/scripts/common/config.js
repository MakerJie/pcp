...
(function ($) {
    ...
    Dolphin.enum.addEnum('chinaCity', [
        ...
        {code: "市辖区", name: '市辖区', logName: "11"},
        {code: "县", name: '县', logName: "11"},

        {code: "市辖区", name: '市辖区', logName: "12"},
        {code: "县", name: '县', logName: "12"},

        {code: "市辖区", name: '市辖区', logName: "31"},
        {code: "县", name: '县', logName: "31"},

        {code: "市辖区", name: '市辖区', logName: "50"},
        {code: "县", name: '县', logName: "50"},
        {code: "市", name: '市', logName: "50"},
        ...
        {code: "", name: '开封市', logName: "41"},
        {code: "开封市", name: '洛阳市', logName: "41"},
        ...
        {code: "", name: '西宁市', logName: "63"},
        {code: "", name: '海东地区', logName: "63"},
        {code: "", name: '海北藏族自治州', logName: "63"},
        {code: "", name: '黄南藏族自治州', logName: "63"},
        {code: "", name: '海南藏族自治州', logName: "63"},
        {code: "", name: '果洛藏族自治州', logName: "63"},
        {code: "", name: '玉树藏族自治州', logName: "63"},
        {code: "", name: '海西蒙古族藏族自治州', logName: "63"},


        {code: "", name: '银川市', logName: "64"},
        {code: "", name: '石嘴山市', logName: "64"},
        {code: "", name: '吴忠市', logName: "64"},
        {code: "", name: '固原市', logName: "64"},
        {code: "", name: '中卫市', logName: "64"},
