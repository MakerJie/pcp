...
const _route = {
    wechat: require('./viewRoutes/wechat')
};

router.all('*', security.checkEndType, security.checkWechat, security.checkAlipay, security.checkOpenId, security.requireAuthentication, security.loadUser);
