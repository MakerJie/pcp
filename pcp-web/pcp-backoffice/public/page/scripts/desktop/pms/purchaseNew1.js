    ...
    org.breezee.page = {
        ...
        initEvent: function () {
            ...
            $("#purchaseShop").change(function () {
                $("#supplyer").empty().attr('optionParam', '{"endpoint":"038","WERKS":"' + $(this).val().substr(0, 4) + '","LGORT":"' + $(this).val().substr(4) + '"}');
                ...
                if (supplyerVal == null || supplyerVal == "") {
                    ...
                    Dolphin.ajax({
                        ...
                        success: function (reData, textStatus) {
                            if (reData.success && reData.rows.length > 0 && reData.rows[0].email) {
            ...
            $('.btn-save').click(function () {
                ...
                me.orderData.menuCode = "purchaseNew1";
                Dolphin.ajax({
        ...
        loadProductList: function () {
            let me = this, d = me.lastSupplier;
            let sp = $("#purchaseShop").val();
        ...
        initDataList: function () {
            ...
            me._dataList = new Dolphin.LIST({
                ...
                columns: [{
                        ...
                        input.change(function () {
                            ...
                            if (row.quantity > 0) {
                                ...
                                me.cartPrd[row.code] = {
                                    ...
                                    orUnit: row.orUnit,
                                    subTotal: (row.quantity * row.price).toFixed(2)
                                };
                            } else {
                                if (me.cartPrd[row.code]) {
                            ...
                            $(this).closest('tr').find('[columncode="subTotal"]').html(me.cartPrd[row.code].subTotal);
                            $("#selectedCount").html(me.selectedCount);
                        });
                        return input
                    }
                    ...
                    width: '90px',
                    formatter: function (val, row) {
                        return row.unitPrice + '/' + row.measureUnit;
                    }
                }, {
                    code: 'subTotal',
                    title: '小计',
                ...
                data: {rows: []},//53afe452392f44b19d64ae88d1de7491
                pagination: false,
        ...
        editList: function () {
            ...
            this._editList = new Dolphin.LIST({
                ...
                columns: [{
                    ...
                    width: '120px',
                    formatter: function (val, row) {
                        let input = $('<input class="form-control" placeholder="采购数量" id="quantity" listname="quantity" >');
