    ...
    org.breezee.page = {
        ...
        initEvent: function () {
            ...
            $("#prints").click(function () {
                ...
                window.open("http://" + window.location.host + org.breezee.context.contextPath + org.breezee.context.viewPrefix + "/pms/details?type=20&data=" + hiddenId);
            });
            $("#printReceive").click(function () {
                let hiddenId = $("#hiddenId").val();
                window.open("http://" + window.location.host + org.breezee.context.contextPath + org.breezee.context.viewPrefix + "/pms/details?type=20&data=" + hiddenId);
            });
