    ...
    org.breezee.page = {
        ...
        initEvent: function () {
            ...
            $("#supplyer").change(function () {
                ...
                if ($(this).val()) {
                    $('#purchaseShop').attr('optionParam', '{"properties":{"pageSize":1000,"_cityShop":"' + $(this).val() + '","type":"1"}}').empty();
            ...
            $('.btn-save').click(function () {
                ...
                me.orderData.menuCode="purchaseNew2";
                Dolphin.ajax({
                    ...
                    org.breezee.buttons.editCallback('80da5b20221f43308ae2a1b389b409e5', 'id', function (data) {
                        ...
                        $.each(retData.purchaseLines, function () {
                            ...
                            me.cartPrd[row.code] = {
                                ...
                                tax: row.tax,
                                quantity: row.quantity,
                                subTotal: row.quantity * Number(row.price)
                            };
